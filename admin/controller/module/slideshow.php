...
class ControllerModuleSlideshow extends Controller {
	...
	public function index() {
		...
		$data['entry_full_height'] = $this->language->get('entry_full_height');
		...
		if (isset($this->request->post['full_heigth'])) {
			$data['full_heigth'] = $this->request->post['full_heigth'];
		} elseif (!empty($module_info)) {
			$data['full_heigth'] = $module_info['full_heigth'];
		} else {
			$data['full_heigth'] = 0;
		}
