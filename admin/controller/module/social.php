...
class ControllerModuleSocial extends Controller {
	...
	public function index() {
		...
		$data['action'] = $this->url->link('module/social', 'token=' . $this->session->data['token'], 'SSL');

		$data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');

		if (isset($this->request->post['social_status'])) {
			$data['social_status'] = $this->request->post['social_status'];
		} else {
			$data['social_status'] = $this->config->get('social_status');
		}
