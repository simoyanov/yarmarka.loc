                  ...
                  <div class="card-body card-padding">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <div class="fg-line">
                            <label class="control-label" for="input-status">Видимость в стате</label>
                            <div class="select">
                              <select name="in_status" id="input-in-status" class="form-control">
                                <?php if (!empty($ar_in_status)) { ?>
                                  <?php foreach ($ar_in_status as $value) { ?>
                                  <?php if ($value['status_id'] == $status) { ?>
                                    <option value="<?php echo $value['status_id']; ?>" selected="selected"><?php echo $value['title']; ?></option>
                                  <?php } else { ?>
                                  <option value="<?php echo $value['status_id']; ?>"><?php echo $value['title']; ?></option>
