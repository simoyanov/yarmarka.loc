        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-information">
          <table class="table">
              ...
              <tbody>
                  ...
                  <tr>
                    <td class="text-center"><?php if (in_array($occasion_group['occasion_group_id'], $selected)) { ?>
                      <input type="checkbox" name="selected[]" value="<?php echo $occasion_group['occasion_group_id']; ?>" checked="checked" />
                      <?php } else { ?>
                      <input type="checkbox" name="selected[]" value="<?php echo $occasion_group['occasion_group_id']; ?>" />
                      <?php } ?></td>
                    <td class="text-left"><?php echo $occasion_group['title']; ?></td>
                    <td class="text-right"><a href="<?php echo $occasion_group['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                  </tr>
                  <?php } ?>
                  <?php } else { ?>
                  <tr>
