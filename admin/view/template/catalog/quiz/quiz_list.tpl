        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-information">
          <table class="table">
              ...
              <tbody>
                  ...
                  <tr>
                    <td class="text-center"><?php if (in_array($quiz['quiz_id'], $selected)) { ?>
                      ...
                      <?php } ?></td>
                    <td class="text-left"><?php echo $quiz['title']; ?></td>
                    <td class="text-right"><a href="<?php echo $quiz['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                  </tr>
                  <?php } ?>
                  <?php } else { ?>
                  <tr>
