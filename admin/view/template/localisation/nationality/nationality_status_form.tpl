                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group <?php if (isset($error_name[$language['language_id']])) { ?> has-error <?php } ?>">
                          <div class="fg-line">
                              <label class="control-label" for="input-nationality_status"><?php echo $entry_name; ?></label>
                              <input type="text" name="nationality_status[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($nationality_status[$language['language_id']]) ? $nationality_status[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" class="form-control" />
                          </div>
