...
class ControllerModuleUlogin extends Controller {
	...
	public function index($setting) {
		...
		$this->document->addScript('catalog/view/vendors/ulogin/js/ulogin.js');
		$this->document->addStyle('catalog/view/vendors/ulogin/css/ulogin.css');
