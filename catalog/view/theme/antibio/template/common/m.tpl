<li class="hidden-md hidden-lg">
                    ...
                    <li class="hidden dropdown dropdown-meganav mega-dropdown-fluid">
                    ...
                    <li class=" hidden dropdown dropdown-aux animate-click" data-animate-in="animated bounceInUp" data-animate-out="animated fadeOutDown" style="z-index:500;">
