...
(function() {
    ...
    trigger.onclick = openClose;
    $('.dummy_map_item').click(openClose);
	...
	function openClose2() {
		...
		if (toCloseIcon2) {
			...
			inB(segmentE);
			inAC(segmentF);
            $('.menu-dummy').css('height','100%');
            $('#dummy2').css('height','100%');
            ...
            $('.menu-dummy').delay(300).css('height','60px');
            $('#dummy2').css('height','10px');
		}
    ...
    trigger2.onclick = openClose2;
    $('.dummy_menu_item').click(openClose2);
...
var news= {
	init:function(){
		...
		$('#newsModal').on('shown.bs.modal', function () {
			 console.log('callback -РѕС‚РєСЂС‹С‚РёРµ РЅРѕРІРѕСЃС‚Рё');
		});
	},
	initBnt:function(){
		$(_news_btn).on(MOUSE_DOWN,function(e){
	        ...
	        $.ajax({
	            ...
	            success: function(obj) {
	                console.log(obj);
	                //РѕС‡РёС‰Р°РµРј РєРѕРЅС‚РµРЅС‚ РІ С„РѕСЂРјРµ 
	                var html = '';
	               	if(obj.success){
	                   ...
	                   console.log('РЅРµ СѓРґР°Р»РѕСЃСЊ СЂР°СЃС€Р°СЂРёС‚СЊ');
	                }
	            },
...
var filtermap = {
  init:function(){
    ...
    objectManager.clusters.options.set({
        ...
        maxZoom: 10,
        gridSize:10,
        hintContentLayout: ymaps.templateLayoutFactory.createClass('Р“СЂСѓРїРїР° РѕР±СЉРµРєС‚РѕРІ')
    });
    ...
    $(document).on(MOUSE_DOWN,'.filter-btn',function(e){
      ...
      //РґРѕР±Р°РІРёС‚СЊ Р°РєС‚РёРІРЅРѕСЃС‚СЊ РєРЅРѕРїРєРё - !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  getInfoAboutPlaces:function(category){
    ...
    //РґРѕР±Р°РІРёС‚СЊ РїСЂРµР»РѕР°РґРµСЂ - !!!!!!!!!!!!!!!!!!!!!!!!
    var url = 'agetplaces';
    $.getJSON(url,{
      category:category
    })
